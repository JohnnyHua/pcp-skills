...
> 一个给 AI 编程助手用的开发流程控制层。它帮助 AI 守住当前主线、安全收纳临时需求，并在切换工具时稳定交接上下文。

**PCP（Progress Control Plane）** 是一层给 AI 编程助手用的开发流程控制系统。它的作用不是替你写代码，而是让 AI 在开发时始终知道自己现在该做什么、临时需求该放哪里、换工具时怎么把上下文交接出去。
